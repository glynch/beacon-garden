...
The resulting `target/export/beacon-garden` directory contains the application
JAR, engine and third-party runtime JARs, host-selected LWJGL natives, runtime
...
runtime; later native packaging can wrap the same contents with a bundled
runtime.
